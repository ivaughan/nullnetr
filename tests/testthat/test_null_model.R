...
c.1.m <- read.csv(system.file("testdata", "df1_cons_m.csv", package = "nullnetr"))
c.1.c <- read.csv(system.file("testdata", "df1_cons_c.csv", package = "nullnetr"))
c.1.q <- read.csv(system.file("testdata", "df1_cons_q.csv", package = "nullnetr"))
r.1 <- read.csv(system.file("testdata", "df1_res.csv", package = "nullnetr"))
c.2 <- read.csv(system.file("testdata", "df2_cons.csv", package = "nullnetr"))
r.2 <- read.csv(system.file("testdata", "df2_res.csv", package = "nullnetr"))
